...
RcppExport SEXP _tonytianHW4_ctmcViterbi(SEXP tsSEXP, SEXP thetaSEXP, SEXP obsSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _tonytianHW4_ctmcForwardBackward(SEXP tsSEXP, SEXP thetaSEXP, SEXP obsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type ts(tsSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_tonytianHW4_ctmcViterbi", (DL_FUNC) &_tonytianHW4_ctmcViterbi, 3},
    {"_tonytianHW4_ctmcForwardBackward", (DL_FUNC) &_tonytianHW4_ctmcForwardBackward, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_tonytianHW4(DllInfo *dll) {
